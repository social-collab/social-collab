 ...
 * 3. Style
 * 4. Social-Collab Customization. Changed file to .php and added style tags to allow php variable insertion
 */
html {
  /* 1 */
  ...
  /* 3 */
  background: #<?php echo $theme_color2; ?>;
...
a,
.uk-link {
  color: #<?php echo $theme_color3; ?>;  /* CHANGE COLOR LINK WHEN TEST ELEMENT EXISTS ON PAGE */
...
.uk-link-toggle:focus .uk-link {
  color: #0f6ecd; /* CHANGE THIS COLOR WHEN TEST ELEMENT EXISTS ON PAGE */
...
:not(pre) > samp {
  ...
  font-size: 0.875rem;
  /* 3 */
  color: #f0506e;   /* CHANGE THIS COLOR WHEN TEST ELEMENT EXISTS ON PAGE */
  white-space: nowrap;
  padding: 2px 6px;
  background: #f8f8f8;   /* CHANGE THIS COLOR WHEN TEST ELEMENT EXISTS ON PAGE */
}
/*
 * Emphasize
 */
 ...
 */
ins {
  background: #ffd;  /* CHANGE THIS COLOR WHEN TEST ELEMENT EXISTS ON PAGE */
  color: #666;   /* CHANGE THIS COLOR WHEN TEST ELEMENT EXISTS ON PAGE */
  text-decoration: none;
}
/*
 * Mark
...
.uk-heading-2xlarge {
  ...
  font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
  font-weight: normal;
  color: <?php echo $theme_color3; ?>; /* CHANGE THIS COLOR WHEN TEST ELEMENT EXISTS ON PAGE */
  text-transform: none;
}
/* Add margin if adjacent element */
* + h1,
